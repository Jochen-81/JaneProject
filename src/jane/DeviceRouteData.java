...
public class DeviceRouteData implements Serializable {
	...
	public DeviceRouteData(Address nextHop, long distanceToDestination, long sequenceNumber) {
		super();
	...
	public String toString() {
		return "DeviceRouteData [nextHop=" + nextHop + ", distanceToDestination=" + distanceToDestination
